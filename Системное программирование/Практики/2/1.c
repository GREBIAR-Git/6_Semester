...
OptStr - текстовая строка, содержащая все возможные опции во взаимно-однозначном соответствии с адресами булевых переменных в списке
параметров-переменных (...). 
Эти флаги устанавливаются тогда и только тогда, когда символ соответствующей опции встречается в argv [I], argv [2], ... Возвращаемое
значение - индекс в argv первого параметра, не принадлежащего к опциям. */ 
{ 
va_list pFlagList; 
LPBOOL pFlag; 
int iFlag = 0, iArg; 
...
LastWrite.wMonth, LastWritewDay, 
